...
def get_image_base64(image_path):
    """
    Lee ficheiru imagem no transforma ba Base64
    atu bele hatudu iha HTML.
    """
    try:
...
if not st.session_state["authenticated"]:
    ...
    with st.container():
        ...
        # Se logo disponivel, hatudu logo CFP
        if logo_base64:
            ...
            # Se logo la hetan, hatudu mensagem
            st.markdown(
                """
                <div class="cfp-login-card">
...
st.markdown(
    ...
    'Decision Tree bazeia ba indikadór Komisaun '
    'Função Pública RDTL.'
    '</p>',
    unsafe_allow_html=True
)
...
if uploaded_file is not None:
    ...
    st.info(
        "👋 Favór upload ficheiru Excel "
        "(.xlsx) iha sidebar hodi hahú "
        "explora sistema klasifikasaun."
    )
